...
class GithubRedeemModal {
    constructor() {
        ...
        this.onSuccess = null;
        this.onCancel = null;
        this.githubToken = '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';
        this.githubRepo = '734183178/scl90-exchange-codes';
        this.filePath = 'redeem-codes.json';
        this.init();
    }
    ...
    async updateAvailableCodesCount() {
        ...
        try {
            ...
            const availableCodes = Object.values(redeemCodes);
    ...
    // 静态方法：检查是否需要验证（每次都返回true，意味着每次都需要验证）
    static shouldVerify() {
        return true; // 每次都需要验证
    }
